      ...
      <div class="container">
        <div class="row d-flex align-items-center justify-content-center">
          <div class="about-content col-lg-12">
            ...
            <p class="text-white link-nav"><a href="/">首页 </a> <span class="lnr lnr-arrow-right"></span> <a href=""> 国际化转换工具</a></p>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="box">
          ...
          <div class="left col-12 col-sm-6">
            ...
            <div class="btn_box col-12 col-sm-12">
              <button
                @click="click_btn_left(0)"
                class="btn btn-primary btn-sm"
              >简体转繁体</button>
              <button
                @click="click_btn_left(1)"
                class="btn btn-secondary btn-sm"
              >繁体转简体</button>
              <button
                @click="click_btn_left(2)"
                class="btn btn-success btn-sm"
              >中文转unicode</button>
              <button
                @click="click_btn_left(3)"
                class="btn btn-info btn-sm"
              >unicode转中文</button>
              <button
                @click="click_btn_left(4)"
...
export default {
  ...
  mounted: function () {
    console.log(this.traditionalized)
  },

  methods: {
    click_btn_left(index) {
      let val = $("#textarea_val1").val();
      let arrayVal = this.toArray(val);
      let str = "";
      var that = this;
      // 组合变量名称
      function steStr(arrayVal, func, res, index) {
      ...
      switch (index) {
        case 0:
          ...
          arrayVal.filter((res, index) => {
            steStr(arrayVal, this.traditionalized, res, index);
          });
        ...
        case 1:
          // 繁体转简体
          arrayVal.filter((res, index) => {
            steStr(arrayVal, this.simplized, res, index);
          });
          $("#textarea_val2").val(str);
          $("#textarea_val2").select();
          document.execCommand("copy");
        ...
        case 2:
          // 中文转unicode
          arrayVal.filter((res, index) => {
            steStr(arrayVal, this.encodeUnicode, res, index);
          });
          $("#textarea_val2").val(str);
          $("#textarea_val2").select();
          document.execCommand("copy");
        ...
        case 3:
          // unicode转中文
          arrayVal.filter((res, index) => {
            steStr(arrayVal, this.decodeUnicode, res, index);
          });
          $("#textarea_val2").val(str);
          $("#textarea_val2").select();
          document.execCommand("copy");
        ...
        case 4:
          // 简体转繁体转unicode
          arrayVal.filter((res, index) => {
            steStr(arrayVal, this.encodeUnicode, this.traditionalized(res), index);
          });
          $("#textarea_val2").val(str);
          $("#textarea_val2").select();
          document.execCommand("copy");
    ...
    setTitles(text) {
      var val = $("#setTitle").val();
      if (val != "") {
        val += "." + this.randomString(8) + "=";
        text = val + text;
        return text;
      } else {
        return text;
    ...
    randomString(len) {
      len = len || 32;
      var $chars =
        "ABCDEFGHJKMNPQRSTWXYZabcdefhijkmnprstwxyzoOLlgqVvUuI"; /****默认去掉了容易混淆的字符oOLl,9gq,Vv,Uu,I1****/
    ...
    convert(nOption) {
      if (nOption == 0) txt.value = this.simplized(txt.value);
      else txt.value = this.traditionalized(txt.value);
    },
  },
};
</script>
